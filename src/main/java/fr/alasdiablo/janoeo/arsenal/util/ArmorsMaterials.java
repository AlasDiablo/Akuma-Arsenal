...
public enum ArmorsMaterials implements IArmorMaterial {
    ...
    COPPER_ARMOR(Registries.COPPER_ARMOR,  7, new int[]{1, 3, 5, 2}, 9, () -> { try { return Ingredient.fromTag(LocalTags.Ingot.COPPER); } catch (IllegalStateException e) {return null;} }, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0F),
    ALUMINIUM_ARMOR(Registries.ALUMINIUM_ARMOR,  6, new int[]{1, 2, 4, 1}, 6, () -> { try { return Ingredient.fromTag(LocalTags.Ingot.ALUMINIUM); } catch (IllegalStateException e) {return null;} }, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0F),
    LEAD_ARMOR(Registries.LEAD_ARMOR,  5, new int[]{1, 2, 4, 1}, 5, () -> { try { return Ingredient.fromTag(LocalTags.Ingot.LEAD); } catch (IllegalStateException e) {return null;} }, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0F),
    SILVER_ARMOR(Registries.SILVER_ARMOR,  15, new int[]{2, 5, 6, 2}, 25, () -> { try { return Ingredient.fromTag(LocalTags.Ingot.SILVER); } catch (IllegalStateException e) {return null;} }, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F, 0F),
    TIN_ARMOR(Registries.TIN_ARMOR, 6, new int[]{1, 2, 4, 1}, 7, () -> { try { return Ingredient.fromTag(LocalTags.Ingot.TIN); } catch (IllegalStateException e) {return null;} }, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0F),
    URANIUM_ARMOR(Registries.URANIUM_ARMOR,  12, new int[]{2, 5, 6, 2}, 9, () -> { try { return Ingredient.fromTag(LocalTags.Ingot.URANIUM); } catch (IllegalStateException e) {return null;} }, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0F);
     ...
     */
    private Supplier<Ingredient> repairItemSupplier;
     ...
     * @param repairItemSupplier repair material(item use for repair the armor) of the material
     * @param soundEvent sound(sound use on equipe) of the material
     * @param toughness toughness of the material
     */
    ArmorsMaterials(String name, int durability, int[] damageReductionAmount, int enchantability, Supplier<Ingredient> repairItemSupplier, SoundEvent soundEvent, float toughness, float knockBackResistance) {
    ...
    public Ingredient getRepairMaterial() {
        return this.repairItemSupplier.get();
    }
